...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002243502885'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7473123628 6888054311').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002174958078').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002248427834') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://rudraF:Rudraksha@896@rudra.mepocit.mongodb.net/?retryWrites=true&w=majority&appName=Rudra")
DATABASE_NAME = environ.get('DATABASE_NAME', "rudramovies")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'rudramovies69')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'rudramovie69_bot') # Support Chat Link Without https:// or @
